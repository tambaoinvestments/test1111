  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 w-full max-w-5xl mx-auto mt-16 md:mt-0">
        <h2 className="text-tambao-yellow font-semibold tracking-widest uppercase text-xs md:text-sm mb-4 animate-fade-in-up">
        ...
        <p className="text-lg md:text-2xl text-slate-200 mb-10 max-w-3xl mx-auto font-light text-balance leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center w-full px-4">
          <a 
            href="#about" 
            className="w-full sm:w-auto px-8 py-4 bg-tambao-green hover:bg-green-600 text-white rounded-full font-medium transition-all transform hover:scale-105 flex items-center justify-center gap-2 shadow-lg shadow-green-900/20"
          >
          ...
          <a 
            href="#contact" 
            className="w-full sm:w-auto px-8 py-4 bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white border border-white/30 rounded-full font-medium transition-all text-center"
          >
            Liên Hệ Hợp Tác
          </a>
        </div>
